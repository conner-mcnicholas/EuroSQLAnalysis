...
--
-- Host: localhost:3306
-- Generation Time: Feb 10, 2022 at 08:20 PM
...
CREATE TABLE `match_details` (
  ...
  `goal_score` varchar(1) DEFAULT NULL,
  `penalty_score` varchar(1) DEFAULT NULL,
  `ass_ref` varchar(5) DEFAULT NULL,
...
CREATE TABLE `match_mast` (
  ...
  `plr_of_match` varchar(6) DEFAULT NULL,
  `stop1_sec` varchar(3) DEFAULT NULL,
  `stop2_sec` varchar(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
('1', 'G', '2016-06-11', 'WIN', 'N', '01-Feb', '20008', '70007', '75113', '160154', '131', '242'),
('2', 'G', '2016-06-11', 'WIN', 'N', '0-1', '20002', '70012', '33805', '160476', '61', '182'),
('3', 'G', '2016-06-11', 'WIN', 'N', '01-Feb', '20001', '70017', '37831', '160540', '64', '268'),
('4', 'G', '2016-06-12', 'DRAW', 'N', '01-Jan', '20005', '70011', '62343', '160128', '0', '185'),
...
('9', 'G', '2016-06-13', 'DRAW', 'N', '01-Jan', '20008', '70010', '73419', '160335', '67', '194'),
('10', 'G', '2016-06-14', 'WIN', 'N', '0-2', '20004', '70005', '55408', '160244', '63', '189'),
('11', 'G', '2016-06-14', 'WIN', 'N', '0-2', '20001', '70018', '34424', '160197', '61', '305'),
('12', 'G', '2016-06-15', 'DRAW', 'N', '01-Jan', '20009', '70004', '38742', '160320', '15', '284'),
('13', 'G', '2016-06-15', 'WIN', 'N', '02-Jan', '20003', '70001', '38989', '160405', '62', '189'),
('14', 'G', '2016-06-15', 'DRAW', 'N', '01-Jan', '20007', '70015', '43576', '160477', '74', '206'),
('15', 'G', '2016-06-16', 'WIN', 'N', '2-0', '20005', '70013', '63670', '160154', '71', '374'),
('16', 'G', '2016-06-16', 'WIN', 'N', '01-Feb', '20002', '70003', '34033', '160540', '62', '212'),
...
('20', 'G', '2016-06-17', 'DRAW', 'N', '02-Feb', '20009', '70005', '38376', '160086', '71', '280'),
('21', 'G', '2016-06-18', 'WIN', 'N', '3-0', '20006', '70010', '33409', '160429', '84', '120'),
('22', 'G', '2016-06-18', 'WIN', 'N', '3-0', '20001', '70004', '39493', '160064', '11', '180'),
('23', 'G', '2016-06-18', 'DRAW', 'N', '01-Jan', '20005', '70015', '60842', '160230', '61', '280'),
...
('32', 'G', '2016-06-22', 'WIN', 'N', '01-Feb', '20001', '70008', '37245', '160085', '70', '282'),
('33', 'G', '2016-06-22', 'WIN', 'N', '01-Feb', '20008', '70009', '68714', '160220', '7', '244'),
('34', 'G', '2016-06-22', 'DRAW', 'N', '03-Mar', '20004', '70002', '55514', '160322', '70', '185'),
('35', 'G', '2016-06-23', 'WIN', 'N', '0-1', '20003', '70014', '44268', '160333', '79', '221'),
('36', 'G', '2016-06-23', 'WIN', 'N', '0-1', '20006', '70003', '34011', '160062', '63', '195'),
('37', 'R', '2016-06-25', 'WIN', 'P', '01-Jan', '20009', '70005', '38842', '160476', '126', '243'),
('38', 'R', '2016-06-25', 'WIN', 'N', '1-0', '20007', '70002', '44342', '160547', '5', '245'),
('39', 'R', '2016-06-26', 'WIN', 'N', '0-1', '20002', '70012', '33523', '160316', '61', '198'),
('40', 'R', '2016-06-26', 'WIN', 'N', '01-Feb', '20004', '70011', '56279', '160160', '238', '203'),
...
('44', 'R', '2016-06-28', 'WIN', 'N', '02-Jan', '20006', '70001', '33901', '160217', '5', '199'),
('45', 'Q', '2016-07-01', 'WIN', 'P', '01-Jan', '20005', '70003', '62940', '160316', '58', '181'),
('46', 'Q', '2016-07-02', 'WIN', 'N', '01-Mar', '20003', '70001', '45936', '160550', '14', '182'),
('47', 'Q', '2016-07-03', 'WIN', 'P', '01-Jan', '20001', '70007', '38764', '160163', '63', '181'),
('48', 'Q', '2016-07-04', 'WIN', 'N', '02-May', '20008', '70008', '76833', '160159', '16', '125'),
...
CREATE TABLE `penalty_shootout` (
  ...
  `kick_no` varchar(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `player_booked` (
  ...
  `play_half` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `player_in_out` (
  ...
  `time_in_out` varchar(3) DEFAULT NULL,
  `play_schedule` varchar(2) DEFAULT NULL,
  `play_half` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `player_mast` (
  ...
  `dt_of_bir` varchar(10) DEFAULT NULL,
...
CREATE TABLE `soccer_team` (
  ...
  `draw` varchar(1) DEFAULT NULL,
  `lost` varchar(1) DEFAULT NULL,
  `goal_for` varchar(1) DEFAULT NULL,
  `goal_agnst` varchar(1) DEFAULT NULL,
  `goal_diff` varchar(2) DEFAULT NULL,
  `points` varchar(1) DEFAULT NULL,
  `group_position` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
